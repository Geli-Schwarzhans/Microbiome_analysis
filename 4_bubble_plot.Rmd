...
```{r}
Data[, Lineage := Lineage %>% str_replace("( (NA|uncultured) >)+", " … >")]
```
...
ggsave(file.path(PLOTS_DIR, g("{PROJECT_NAME}_taxa_bubble_plot.pdf")), device = cairo_pdf, width = 26, height = 8, limitsize = FALSE)
```
